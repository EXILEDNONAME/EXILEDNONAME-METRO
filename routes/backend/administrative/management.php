...
Route::group([
    ...
    Route::get('chart', 'PermissionController@chart')->name('chart');
...
Route::group([
    ...
    Route::get('selected-reset-password', 'UserController@selected_reset_password')->name('selected-reset-password');
